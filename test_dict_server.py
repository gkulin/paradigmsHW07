...
class TestCherrypyPrimer(unittest.TestCase):
    ...
    SITE_URL = 'http://localhost:51034' #'http://student04.cse.nd.edu:510XX' #Replace this your port number and machine
    ...
    def test_dict_put_key(self):
        ...
        self.assertTrue(self.is_json(r.content.decode()))
        resp = json.loads(r.content.decode())
        self.assertEqual(resp['value'], m['value'])         # I get an 'error' on this test: KeyError: 'value'
